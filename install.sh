...
sudo iptables -t nat -A PREROUTING -d 24.91.159.44 -p tcp --dport 51820 -j DNAT --to-dest 10.8.95.0:51820
sudo iptables -t nat -A POSTROUTING -d 10.8.95.0 -p tcp --dport 51820 -j SNAT --to-source 10.8.95.0
sudo netfilter-persistent save
