...
scp ./key.pub hostname@static_IP_of_rpi:~/ # ssh into the rpi box now.. cd ~ or cd $HOME to be where secure copy places this public key file
...
cd ~/ovpns && scp ./hostname.ovpn hostname_of_machine_to_use_VPN@its_iP:~/ # places it in home directory, might need to run 
